...
public class DataSocket {
     ...
     * @return 
     */
    public String exportDataSendMessage(String user, String message){
        JSONObject jo = new JSONObject();        
        JSONObject data = new JSONObject();
     ...
     * @return 
     */
    public String exportDataWaitingPairing(String nickname) {
        JSONObject jo = new JSONObject();
        JSONObject data = new JSONObject();
     ...
     * @return 
     */
    public String exportDataGetPairing(String nickname, boolean is_accepted) {
        JSONObject jo = new JSONObject();
        JSONObject data = new JSONObject();

        jo.put("type", "get_pairing");
        data.put("nickname", nickname);
     ...
     * @return 
     */
    public String exportDataOutRoom(String nickname) {
        JSONObject jo = new JSONObject();
        JSONObject data = new JSONObject();
     ...
     * @return 
     */
    public String exportDataExitApp(String nickname) {
        JSONObject jo = new JSONObject();
        JSONObject data = new JSONObject();
     ...
     * @return 
     */
    public String exportDataOutWaiting(String nickname) {
        JSONObject jo = new JSONObject();
        JSONObject data = new JSONObject();
